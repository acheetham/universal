...
var onRequest = function (request, response) {  
    ...
    default:
        ...
        else if(path.indexOf("FullNoPreviewUIOptions.html") !== -1)
            sendFile("./infusion-1.4/components/uiOptions/html/FullNoPreviewUIOptions.html", response);
        else if(path.indexOf("UIOptionsTemplate-text.html") !== -1)
            sendFile("./infusion-1.4/components/uiOptions/html/UIOptionsTemplate-text.html", response);
        else if(path.indexOf("UIOptionsTemplate-links.html") !== -1)
            sendFile("./infusion-1.4/components/uiOptions/html/UIOptionsTemplate-links.html", response);
        else if(path.indexOf("UIOptionsTemplate-layout.html") !== -1)
            sendFile("./infusion-1.4/components/uiOptions/html/UIOptionsTemplate-layout.html", response);        
        else {
