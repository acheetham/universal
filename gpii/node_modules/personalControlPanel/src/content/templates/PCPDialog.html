<form id="options" enctype="application/x-www-form-urlencoded" action="/pcp/update"
method="post" class="fl-uiOptions fl-uiOptions-fullNoPreview fl-col-fixed-72em fl-focus">
...
-->
    <br>
        <br> <br>
        <div id="box" class="box clear" style="width:15%;margin-left:auto;margin-right:auto;">
            <input type="button" class="flc-uiOptions-save" value="update" style="width:3.5cm;margin-left:5cm;" />
        </div>
   <!-- </div> <div class="fl-text-align-center fl-uiOptions-buttons">
        ...
        />
        <input class="flc-uiOptions-cancel fl-uiOptions-cancel" type="button"
        value="Cancel" />
      -->
